...
class SMACv2Decomposer:
    def __init__(self, args):
       
        # Load map params
        self.map_name = args.env_args["map_name"]
        self.scenario = args.env_args["scenario"]

        map_params = get_map_params(self.scenario)
        self.map_params = map_params
        self.state_features = args.state_features
        ...
        self.obs_dim = self.move_feats + self.enemy_feats + self.ally_feats + self.own_feats + self.n_agents
    ...
    def get_obs_size(self):
        ...
        own_feats = 2 + self.unit_type_bits
