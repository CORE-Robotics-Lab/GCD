...
env = smacv2.SMACv2("terran_5_vs_5")  # Change SMACv2 Scenario Here


dataset = env.get_dataset("Replay", datasets_base_dir=os.environ.get('DATASET_DIR_PREFIX'))  # Change Dataset Type Here
