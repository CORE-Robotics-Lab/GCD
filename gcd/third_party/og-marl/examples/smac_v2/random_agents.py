...
def main():
    ...
    for e in range(n_episodes):
        ...
        # create a txt file with the index number for each line followed by the feature name
        with open("state_features.txt", "w") as f:
        ...
        while not terminated:
            obs = env.get_obs()
            print(f"Obs size: {obs[0].shape}") # obs is length of agents 
            state = env.get_state()
