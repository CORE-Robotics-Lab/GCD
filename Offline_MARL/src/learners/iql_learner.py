...
class IQLLearner:
    ...
    def save_models(self, path):
        ...
        th.save(self.q.state_dict(), "{}/q.th".format(path))
        th.save(self.value.state_dict(), "{}/value.th".format(path))
        

    def load_models(self, path):
        self.mac.load_models(path)
        self.q.load_state_dict(th.load("{}/q.th".format(path), map_location=lambda storage, loc: storage))
        self.value.load_state_dict(th.load("{}/value.th".format(path), map_location=lambda storage, loc: storage))
